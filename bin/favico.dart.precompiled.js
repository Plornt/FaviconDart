...
// Native classes
init.mangledNames = {fadeIn$1: "fadeIn:1:0"};
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedInteger|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|TextMetrics"
  },
  JSBool: {
    "": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _WorkerSendPort: {
    ...
    get$hashCode: function(_) {
      var t1, t2;
      t1 = J.$xor$n(J.$shl$n(this._workerId, 16), J.$shl$n(this._isolateId, 8));
  ...
  JSInvocationMirror: {
    ...
    get$namedArguments: function() {
      ...
      for (; i < namedArgumentCount; ++i)
        map.$indexSet(0, new H.Symbol0(t2.$index(t1, i)), t4.$index(t3, namedArgumentsStartIndex + i));
      return map;
    },
...
["dart.async", "dart:async", , P, {
  ...
  scheduleMicrotask: function(callback) {
    ...
    if (t1 === C.C__RootZone) {
      t1.scheduleMicrotask$1(callback);
      return;
    }
  ...
  _Future: {
    ...
    static: {"": "_Future__INCOMPLETE,_Future__PENDING_COMPLETE,_Future__CHAINED,_Future__VALUE,_Future__ERROR", _Future$: function($T) {
        ...
        for (t2 = source; true;) {
          ...
          if (t2 && !t1.source_4.get$_zone().inSameErrorZone$1(zone)) {
            asyncError = t1.source_4.get$_error();
            t1.source_4.get$_zone().handleUncaughtError$2(J.get$error$x(asyncError), asyncError.get$stackTrace());
            return;
          }
...
["dart.core", "dart:core", , P, {
  ...
  NoSuchMethodError: {
    ...
    toString$0: function(_) {
      ...
      if (t2 != null)
        for (t3 = J.getInterceptor$asx(t2), t4 = 0; t4 < t3.get$length(t2); i = t1.i_1 + 1, t1.i_1 = i, t4 = i) {
          t4 = t1.i_1;
          if (t4 > 0) {
            t5 = t1.sb_0;
  ...
  Object: {
    ...
    fadeIn$1: function($0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("fadeIn", "fadeIn$1", 0, [$0], []));
    },
    "+fadeIn:1:0": 0,
    ...
    get$state: function($receiver) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("state", "get$state", 1, [], []));
    },
    ...
    get$targetX: function($receiver) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("targetX", "get$targetX", 1, [], []));
    },
    get$targetY: function($receiver) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("targetY", "get$targetY", 1, [], []));
    },
    ...
    set$autoplay: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("autoplay=", "set$autoplay", 2, [$0], []));
    },
    ...
    set$loop: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("loop=", "set$loop", 2, [$0], []));
    },
    set$opacity: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("opacity=", "set$opacity", 2, [$0], []));
    },
    set$rel: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("rel=", "set$rel", 2, [$0], []));
    },
    set$src: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("src=", "set$src", 2, [$0], []));
    },
    set$targetX: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("targetX=", "set$targetX", 2, [$0], []));
    },
    set$targetY: function($receiver, $0) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("targetY=", "set$targetY", 2, [$0], []));
    },
    ...
    toDataUrl$0: function($receiver) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("toDataUrl", "toDataUrl$0", 0, [], []));
    },
    toLowerCase$0: function($receiver) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("toLowerCase", "toLowerCase$0", 0, [], []));
    },
    translate$2: function($receiver, $0, $1) {
      return this.noSuchMethod$1(this, H.createInvocationMirror("translate", "translate$2", 0, [$0, $1], []));
    }
  },
  StackTrace: {
    "": "Object;"
...
["dart.dom.html", "dart:html", , W, {
  ...
  AnchorElement: {
    "": "HtmlElement;rel},type},hostname=,href%,port=,protocol=",
    toString$0: function(receiver) {
  ...
  MediaElement: {
    "": "HtmlElement;autoplay},duration=,error=,loop},src%",
  ...
  _ChildNodeListLazy: {
    ...
    addAll$1: function(_, iterable) {
      ...
      for (t1 = iterable.get$iterator(iterable), t2 = this._this; t1.moveNext$0();)
        t2.appendChild(t1._html$_current);
    },
    $indexSet: function(_, index, value) {
      var t1, t2;
      t1 = this._this;
...
["dart.dom.svg", "dart:svg", , P, {
  ...
  FEConvolveMatrixElement: {
    "": "SvgElement;targetX=,targetY=,width=,x=,y=",
  ...
  ImageElement0: {
    "": "GraphicsElement;width=,x=,y=,href=",
    "%": "SVGImageElement"
  },
  MaskElement: {
    "": "SvgElement;width=,x=,y=",
...
["", "favico.dart", , N, {
  "": "",
  main: [function() {
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_load._eventType, false), [null]);
  ...
  FaviconDrawable_registerTransition: function($name, transition) {
    if (!$.get$FaviconDrawable__transitions().containsKey$1($name)) {
      $.get$FaviconDrawable__transitions().$indexSet(0, $name, transition);
      return true;
    }
    return false;
  },
  FaviconDrawable__init: function() {
    if (!$.FaviconDrawable__initialized) {
      var t1 = new N.FaviconDrawable__init_slide();
      N.FaviconDrawable_registerTransition(C.Symbol_slide, t1);
      N.FaviconDrawable_registerTransition(C.Symbol_slideInUp, new N.FaviconDrawable__init_closure(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideInDown, new N.FaviconDrawable__init_closure0(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideInLeft, new N.FaviconDrawable__init_closure1(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideInRight, new N.FaviconDrawable__init_closure2(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideOutUp, new N.FaviconDrawable__init_closure3(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideOutDown, new N.FaviconDrawable__init_closure4(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideOutLeft, new N.FaviconDrawable__init_closure5(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_slideOutRight, new N.FaviconDrawable__init_closure6(t1));
      t1 = new N.FaviconDrawable__init_fade();
      N.FaviconDrawable_registerTransition(C.Symbol_fade, t1);
      N.FaviconDrawable_registerTransition(C.Symbol_fadeIn, new N.FaviconDrawable__init_closure7(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_fadeOut, new N.FaviconDrawable__init_closure8(t1));
      N.FaviconDrawable_registerTransition(C.Symbol_wait, new N.FaviconDrawable__init_closure9());
    }
  },
  main_closure: {
    "": "Closure:11;",
    call$1: function(ev) {
      var img, t1, icon, badge, v, vSource, vSourceOther, b;
      img = document.createElement("link", null);
      t1 = J.getInterceptor$x(img);
      t1.set$rel(img, "icon");
      t1.set$type(img, "image/png");
      icon = new N.Favicon(null, null, H.setRuntimeTypeInfo([], [N.FaviconDrawable]), img, false, 16, new P.Stopwatch(null, null), 0);
      icon.Favicon$2$destinationElement$size(img, 16);
      badge = new N.FaviconBadge(null, null, "bold 8px sans-serif", "round", C.FaviconPosition_3, H.setRuntimeTypeInfo([], [J.JSInt]), 0, 0, 0, false, H.setRuntimeTypeInfo([], [N.FaviconFrame]), new N.FaviconFrame(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), H.setRuntimeTypeInfo([], [N.FavicoTween])), false, 0, 0, 1, 1, 0, 0, 0, 0, 1, 1, null);
      badge.FaviconBadge$6$backgroundColor$font$fontColor$padding$position$type(null, "bold 8px sans-serif", null, 0, C.FaviconPosition_3, "round");
      icon.addElement$1(N.FaviconIconSource$(null));
      v = document.createElement("video", null);
      vSource = document.createElement("source", null);
      J.set$src$x(vSource, "chromeicon.webm");
      vSourceOther = document.createElement("source", null);
      J.set$src$x(vSourceOther, "chromeicon.mp4");
      v.appendChild(vSource);
      v.appendChild(vSourceOther);
      J.set$display$x(v.style, "none");
      t1 = J.getInterceptor$x(v);
      t1.set$autoplay(v, true);
      t1.set$loop(v, true);
      document.body.appendChild(v);
      icon.addElement$1(new N.FaviconVideoSource(v, true, false, H.setRuntimeTypeInfo([], [N.FaviconFrame]), new N.FaviconFrame(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), H.setRuntimeTypeInfo([], [N.FavicoTween])), false, 0, 0, 1, 1, 0, 0, 0, 0, 1, 1, null));
      badge.opacity = 0;
      icon.addElement$1(badge);
      document.head.appendChild(img);
      b = document.createElement("button", null);
      t1 = J.getInterceptor$x(b);
      t1.set$innerHtml(b, "+ 1");
      t1 = t1.get$onClick(b);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.main__closure(badge)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  main__closure: {
    ...
    call$1: function(ev) {
      var t1, t2;
      t1 = this.badge_0;
      t1._isTransitioning = false;
      t1._currentQueue = new N.FaviconFrame(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), H.setRuntimeTypeInfo([], [N.FavicoTween]));
      t1._animationQueue = H.setRuntimeTypeInfo([], [N.FaviconFrame]);
      t1.opacity = 0;
      t1.fadeIn$1(300);
      t2 = t1._lastBadgeNum + 1;
      t1._lastBadgeNum = t2;
      t1._lastBadgeNum = t2;
      t1.badgeUpdateQueue.push(t2);
      t1._isTransitioning = true;
      t1._animationQueue.push(t1._currentQueue);
      t1._currentQueue = new N.FaviconFrame(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), H.setRuntimeTypeInfo([], [N.FavicoTween]));
    }
  },
  Favicon: {
    "": "Object;_canvas,_context,elements,destinationElement,updateFavicon,size>,_stopwatch,_prevFrameTime",
    _beginLoop$0: [function() {
      var t1, t2, t, timeElapsed, eleLength, x, currentDrawable;
      P.Timer_Timer(P.Duration$(0, 0, 0, 33, 0, 0), this.get$_beginLoop());
      t1 = this._canvas;
      t2 = J.getInterceptor$x(t1);
      t2.set$width(t1, t2.get$width(t1));
      t = C.JSNumber_methods._tdivFast$1(this._stopwatch.get$elapsedTicks() * 1000000, 1000000) / 1000;
      timeElapsed = t - this._prevFrameTime;
      this._prevFrameTime = t;
      t1 = this.elements;
      eleLength = t1.length;
      for (x = 0; x < eleLength; ++x) {
        if (x < 0 || x >= t1.length)
          return H.ioore(t1, x);
        currentDrawable = t1[x];
        currentDrawable._onUpdate$1(timeElapsed);
        if (!currentDrawable._remove)
          currentDrawable.onDraw$1(this._context);
        else {
          C.JSArray_methods.removeAt$1(t1, x);
          --x;
          --eleLength;
        }
      }
      this.updateImage$1(J.toDataUrl$0$x(this._canvas));
    }, "call$0", "get$_beginLoop", 0, 0, 0],
    updateImage$1: function(base64Image) {
      var t1, t2;
      if (!this.updateFavicon) {
        t1 = this.destinationElement;
        t2 = J.getInterceptor$ax(t1);
        if (!!t2.$isLinkElement) {
          document.head.appendChild(t1);
          t2.remove$0(t1);
          t1.setAttribute("href", base64Image);
          return;
        }
        t1.setAttribute("src", base64Image);
      }
    },
    addElement$1: function(drawable) {
      drawable._parent = this;
      this.elements.push(drawable);
    },
    Favicon$2$destinationElement$size: function(destinationElement, size) {
      var e, t1;
      e = document.createElement("canvas", null);
      this._canvas = e;
      t1 = this.size;
      J.set$width$x(e, t1);
      J.set$height$x(this._canvas, t1);
      this._context = J.getContext$1$x(this._canvas, "2d");
      N.FaviconDrawable__init();
      this._stopwatch.start$0(0);
      P.Timer_Timer(P.Duration$(0, 0, 0, 33, 0, 0), this.get$_beginLoop());
    }
  },
  FaviconDrawable: {
    "": "Object;x*,y*,opacity*,targetX*,targetY*,targetOpacity?",
    get$scaledWidth: function() {
      return this.width * this.scale;
    },
    get$scaledHeight: function() {
      return this.height * this.scale;
    },
    get$parent: function(_) {
      return this._parent;
    },
    _onUpdate$1: function(timeSinceLastFrame) {
      var t1, currentAnimationQueue, t2, animLength, allComplete, animX, currentAnimation, isComplete;
      if (this._isTransitioning) {
        t1 = this._animationQueue;
        if (t1.length > 0) {
          currentAnimationQueue = t1[0];
          t2 = currentAnimationQueue.transitions;
          animLength = t2.length;
          if (animLength > 0) {
            if (t2[0].frameNumber === 0)
              this.onBeforeAnimationQueueBegin$0();
            for (allComplete = true, animX = 0; animX < animLength; ++animX) {
              if (animX < 0 || animX >= t2.length)
                return H.ioore(t2, animX);
              currentAnimation = t2[animX];
              isComplete = $.get$FaviconDrawable__transitions().$index(0, currentAnimation.animationName).call$4(this, timeSinceLastFrame, currentAnimation.parameters, currentAnimation);
              currentAnimation.frameNumber = currentAnimation.frameNumber + 1;
              currentAnimation.duration = currentAnimation.duration + timeSinceLastFrame;
              if (isComplete === true) {
                t1 = currentAnimation.c.future;
                if (t1._state !== 0)
                  H.throwExpression(P.StateError$("Future already completed"));
                t1._asyncComplete$1(this);
                C.JSArray_methods.removeAt$1(t2, animX);
                --animX;
                --animLength;
              } else
                allComplete = false;
            ...
            if (allComplete) {
              ...
              this.onAnimationQueueEnd$0();
              t1 = currentAnimationQueue.c.future;
              if (t1._state !== 0)
                H.throwExpression(P.StateError$("Future already completed"));
              t1._asyncComplete$1(this);
              C.JSArray_methods.removeAt$1(this._animationQueue, 0);
            }
          } else {
            C.JSArray_methods.removeAt$1(t1, 0);
            this.onBeforeAnimationQueueBegin$0();
            this._onUpdate$1(timeSinceLastFrame);
            return;
          }
        } else
          this.onAnimationQueueEnd$0();
      }
      this.onUpdate$1(timeSinceLastFrame);
    },
    onAnimationQueueEnd$0: function() {
      return;
    },
    onBeforeAnimationQueueBegin$0: function() {
      return;
    },
    onUpdate$1: function(timeSinceLastFrame) {
    },
    noSuchMethod$1: function(_, invoke) {
      var t1, t2, t3, t4;
      if (invoke.get$isMethod() === true)
        if ($.get$FaviconDrawable__transitions().containsKey$1(invoke.get$memberName())) {
          t1 = invoke.get$memberName();
          t2 = invoke.get$positionalArguments();
          ...
          this._currentQueue.transitions.push(new N.FavicoTween(t1, t3, 0, 0, t4, t2));
          return t3.future;
        }
      P.Object.prototype.noSuchMethod$1.call(this, this, invoke);
    }
  },
  FaviconDrawable__init_slide: {
    "": "Closure:21;",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2, duration, isIn, directions, isLeft, t3, step, isComplete, isUp;
      t1 = J.getInterceptor$asx(parameters);
      if (J.$gt$n(t1.get$length(parameters), 1)) {
        t2 = t1.$index(parameters, 1);
        t2 = typeof t2 === "number" && Math.floor(t2) === t2;
      } else
        t2 = false;
      duration = t2 ? t1.$index(parameters, 1) : 1000;
      if (J.$gt$n(t1.get$length(parameters), 2)) {
        t2 = t1.$index(parameters, 2);
        t2 = typeof t2 === "boolean";
      } else
        t2 = false;
      isIn = !t2 || t1.$index(parameters, 2);
      directions = t1.$index(parameters, 0);
      if (directions.containsKey$1("left") === true || directions.containsKey$1("right") === true) {
        isLeft = J.$eq(J.$index$asx(directions, "left"), true);
        if (item.get$isFirstFrame() === true)
          if (isIn === true) {
            t1 = J.getInterceptor$x(drawable);
            t1.set$targetX(drawable, 0);
            if (isLeft)
              t2 = J.get$size$x(t1.get$parent(drawable));
            else {
              t2 = J.get$size$x(t1.get$parent(drawable));
              if (typeof t2 !== "number")
                return H.iae(t2);
            ...
            t1.set$x(drawable, t2);
          } else {
            t1 = J.getInterceptor$x(drawable);
            if (isLeft) {
              t1 = J.get$size$x(t1.get$parent(drawable));
              if (typeof t1 !== "number")
                return H.iae(t1);
              t1 = 0 - t1;
            } else
              t1 = J.get$size$x(t1.get$parent(drawable));
            J.set$x$x(drawable, t1);
          }
        t1 = J.getInterceptor$x(drawable);
        t2 = P.max(t1.get$targetX(drawable), drawable.get$scaledWidth());
        t3 = P.min(t1.get$targetX(drawable), drawable.get$scaledWidth());
        if (typeof duration !== "number")
          return H.iae(duration);
        step = (t2 - t3) / duration;
        if (isLeft) {
          t2 = t1.get$x(drawable);
          if (typeof deltaT !== "number")
            return H.iae(deltaT);
          t1.set$x(drawable, J.$sub$n(t2, step * deltaT));
        } else {
          t2 = t1.get$x(drawable);
          if (typeof deltaT !== "number")
            return H.iae(deltaT);
          t1.set$x(drawable, J.$add$ns(t2, step * deltaT));
        }
        if (!(isLeft && J.$lt$n(t1.get$x(drawable), t1.get$targetX(drawable)) === true))
          t2 = !isLeft && J.$gt$n(t1.get$x(drawable), t1.get$targetX(drawable)) === true;
        else
          t2 = true;
        if (t2) {
          t1.set$x(drawable, t1.get$targetY(drawable));
          isComplete = true;
        } else
          isComplete = false;
      } else
        isComplete = true;
      if (directions.containsKey$1("up") === true || directions.containsKey$1("down") === true) {
        isUp = J.$eq(J.$index$asx(directions, "up"), true);
        if (item.get$isFirstFrame() === true)
          if (isIn === true) {
            t1 = J.getInterceptor$x(drawable);
            t1.set$targetY(drawable, 0);
            if (isUp)
              t2 = J.get$size$x(t1.get$parent(drawable));
            else {
              t2 = J.get$size$x(t1.get$parent(drawable));
            ...
            if (isUp) {
              ...
              t1 = J.get$size$x(t1.get$parent(drawable));
            J.set$y$x(drawable, t1);
          }
        t1 = J.getInterceptor$x(drawable);
        t2 = P.max(t1.get$targetY(drawable), drawable.get$scaledHeight());
        t3 = P.min(t1.get$targetY(drawable), drawable.get$scaledHeight());
        if (typeof duration !== "number")
          return H.iae(duration);
        step = (t2 - t3) / duration;
        if (isUp) {
          t2 = t1.get$y(drawable);
          if (typeof deltaT !== "number")
            return H.iae(deltaT);
          t1.set$y(drawable, J.$sub$n(t2, step * deltaT));
        } else {
          t2 = t1.get$y(drawable);
          if (typeof deltaT !== "number")
            return H.iae(deltaT);
          t1.set$y(drawable, J.$add$ns(t2, step * deltaT));
        }
        if (!(isUp && J.$lt$n(t1.get$y(drawable), t1.get$targetY(drawable)) === true))
          t2 = !isUp && J.$gt$n(t1.get$y(drawable), t1.get$targetY(drawable)) === true;
        else
          t2 = true;
        if (t2)
          t1.set$y(drawable, t1.get$targetY(drawable));
        else
          isComplete = false;
      }
      return isComplete;
  ...
  FaviconDrawable__init_closure: {
    "": "Closure:22;slide_0",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["up", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_0.call$4(drawable, deltaT, [t1, t2], item);
    }
  },
  FaviconDrawable__init_closure0: {
    "": "Closure:22;slide_1",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["down", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_1.call$4(drawable, deltaT, [t1, t2], item);
    }
  },
  FaviconDrawable__init_closure1: {
    "": "Closure:22;slide_2",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["left", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_2.call$4(drawable, deltaT, [t1, t2], item);
    }
  },
  FaviconDrawable__init_closure2: {
    "": "Closure:22;slide_3",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["right", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_3.call$4(drawable, deltaT, [t1, t2], item);
    }
  },
  FaviconDrawable__init_closure3: {
    "": "Closure:22;slide_4",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["up", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_4.call$4(drawable, deltaT, [t1, t2, false], item);
    }
  },
  FaviconDrawable__init_closure4: {
    "": "Closure:22;slide_5",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["down", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_5.call$4(drawable, deltaT, [t1, t2, false], item);
    }
  },
  FaviconDrawable__init_closure5: {
    "": "Closure:22;slide_6",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["left", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_6.call$4(drawable, deltaT, [t1, t2, false], item);
    }
  },
  FaviconDrawable__init_closure6: {
    "": "Closure:22;slide_7",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2;
      t1 = H.fillLiteralMap(["right", true], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = J.getInterceptor$asx(parameters);
      t2 = J.$gt$n(t2.get$length(parameters), 0) ? t2.$index(parameters, 0) : 1000;
      return this.slide_7.call$4(drawable, deltaT, [t1, t2, false], item);
    }
  },
  FaviconDrawable__init_fade: {
    "": "Closure:21;",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1, t2, duration, targetOpacity, towards, t3, opacityStep, isComplete;
      t1 = J.getInterceptor$asx(parameters);
      if (J.$ge$n(t1.get$length(parameters), 1)) {
        t2 = t1.$index(parameters, 0);
        t2 = typeof t2 === "number" && Math.floor(t2) === t2;
      } else
        t2 = false;
      duration = t2 ? t1.$index(parameters, 0) : 1000;
      if (J.$ge$n(t1.get$length(parameters), 2)) {
        t2 = t1.$index(parameters, 1);
        t2 = typeof t2 === "number";
      } else
        t2 = false;
      targetOpacity = t2 ? t1.$index(parameters, 1) : 1;
      t1 = J.getInterceptor$x(item);
      if (item.get$isFirstFrame() === true) {
        t2 = J.getInterceptor$x(drawable);
        J.$indexSet$ax(t1.get$state(item), "towards", J.$lt$n(t2.get$opacity(drawable), targetOpacity));
        towards = J.$lt$n(t2.get$opacity(drawable), targetOpacity);
        t3 = P.max(targetOpacity, t2.get$opacity(drawable));
        t2 = P.min(targetOpacity, t2.get$opacity(drawable));
        if (typeof duration !== "number")
          return H.iae(duration);
        opacityStep = (t3 - t2) / duration;
        if (towards !== true)
          opacityStep = -opacityStep;
        J.$indexSet$ax(t1.get$state(item), "opacityStep", opacityStep);
        drawable.set$targetOpacity(targetOpacity);
      } else {
        opacityStep = J.$index$asx(t1.get$state(item), "opacityStep");
        towards = J.$index$asx(t1.get$state(item), "towards");
      }
      t1 = J.getInterceptor$x(drawable);
      t1.set$opacity(drawable, J.$add$ns(t1.get$opacity(drawable), J.$mul$n(opacityStep, deltaT)));
      t2 = towards === true;
      if (!(t2 && J.$gt$n(t1.get$opacity(drawable), targetOpacity) === true))
        t2 = !t2 && J.$lt$n(t1.get$opacity(drawable), targetOpacity) === true;
      else
        t2 = true;
      if (t2) {
        t1.set$opacity(drawable, targetOpacity);
        isComplete = true;
      } else
        isComplete = false;
      return isComplete;
  ...
  FaviconDrawable__init_closure7: {
    "": "Closure:22;fade_8",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1;
      if (item.get$isFirstFrame() === true)
        J.set$opacity$x(drawable, 0);
      t1 = J.getInterceptor$asx(parameters);
      t1 = J.$gt$n(t1.get$length(parameters), 0) ? t1.$index(parameters, 0) : 1000;
      return this.fade_8.call$4(drawable, deltaT, [t1, 1], item);
    }
  },
  FaviconDrawable__init_closure8: {
    "": "Closure:22;fade_9",
    call$4: function(drawable, deltaT, parameters, item) {
      var t1 = J.getInterceptor$asx(parameters);
      t1 = J.$gt$n(t1.get$length(parameters), 0) ? t1.$index(parameters, 0) : 1000;
      return this.fade_9.call$4(drawable, deltaT, [t1, 0], item);
    }
  },
  FaviconDrawable__init_closure9: {
    "": "Closure:22;",
    call$4: function(drawable, deltaT, parameters, item) {
      return J.$ge$n(J.get$duration$x(item), J.$index$asx(parameters, 0));
    }
  },
  FaviconFrame: {
    "": "Object;c,transitions"
  },
  FavicoTween: {
    "": "Object;animationName,c,duration>,frameNumber,state>,parameters",
    get$isFirstFrame: function() {
      return this.frameNumber === 0;
    }
  },
  FaviconPosition: {
    "": "Object;pos",
    static: {"": "FaviconPosition_TOP_LEFT,FaviconPosition_TOP_RIGHT,FaviconPosition_BOTTOM_LEFT,FaviconPosition_BOTTOM_RIGHT"}
  },
  RGBA: {
    "": "Object;r,g,b,a,alphaMod",
    toString$0: function(_) {
      var t1, t2;
      t1 = "rgba(" + this.r + ", " + this.g + ", " + this.b + ", ";
      t2 = this.alphaMod;
      if (typeof t2 !== "number")
        return H.iae(t2);
      return t1 + H.S(this.a * t2) + ")";
    }
  },
  FaviconBadge: {
    "": "FaviconDrawable;backgroundColor,fontColor,font,type,position,badgeUpdateQueue,currBadge,padding,_lastBadgeNum,_remove,_animationQueue,_currentQueue,_isTransitioning,x,y,scale,opacity,width,height,targetX,targetY,targetScale,targetOpacity,_parent",
    onBeforeAnimationQueueBegin$0: function() {
      var t1 = this.badgeUpdateQueue;
      if (t1.length > 0) {
        this.currBadge = t1[0];
        C.JSArray_methods.removeAt$1(t1, 0);
      }
    ...
    onAnimationQueueEnd$0: function() {
      if (this.badgeUpdateQueue.length > 0)
        this._isTransitioning = true;
    },
    convertBadgeToText$1: function(badgeNum) {
      if (badgeNum > 999999)
        return C.JSInt_methods.toStringAsFixed$1(badgeNum / 1000000, 1) + "M";
      if (badgeNum > 999)
        return C.JSInt_methods.toStringAsFixed$1(badgeNum / 1000, 1) + "K";
      return C.JSInt_methods.toString$0(badgeNum);
    },
    onDraw$1: function(ctx) {
      var badgeText, t1, fontWidth, t2, t3, t4, t5, t6;
      badgeText = this.convertBadgeToText$1(this.currBadge);
      t1 = J.getInterceptor$x(ctx);
      t1.set$font(ctx, this.font);
      fontWidth = t1.measureText$1(ctx, badgeText).width;
      if (typeof fontWidth !== "number")
        return fontWidth.$add();
      this.width = fontWidth + 4;
      this.height = 10;
      t2 = this.backgroundColor;
      t2.alphaMod = this.opacity;
      t1.set$fillStyle(ctx, J.toString$0(t2));
      switch (this.position) {
        case C.FaviconPosition_0:
          t1.translate$2(ctx, 2, 2);
          break;
        case C.FaviconPosition_1:
          t1.translate$2(ctx, this._parent.size - this.width - this.padding, 2);
          break;
        case C.FaviconPosition_2:
          t1.translate$2(ctx, 2, this._parent.size - this.height - this.padding);
          break;
        case C.FaviconPosition_3:
          t2 = this._parent.size;
          t3 = this.padding;
          t1.translate$2(ctx, t2 - this.width - t3, t2 - this.height - t3);
          break;
        default:
      }
      t2 = this.type;
      ...
      t6 = this.height;
      if (t2 === "round")
        t1.fillRect$4(ctx, t3, t4, t5, t6);
      else
        t1.fillRect$4(ctx, t3, t4, t5, t6);
      t2 = this.fontColor;
      t2.alphaMod = this.opacity;
      t1.set$fillStyle(ctx, J.toString$0(t2));
      t2 = this.convertBadgeToText$1(this.currBadge);
      t3 = J.$add$ns(this.x, 2);
      t4 = this.y;
      if (typeof t4 !== "number")
        return H.iae(t4);
      t1.fillText$3(ctx, t2, t3, 8 + t4);
    },
    onUpdate$1: function(deltaT) {
    },
    FaviconBadge$6$backgroundColor$font$fontColor$padding$position$type: function(backgroundColor, font, fontColor, padding, position, type) {
      if (this.backgroundColor == null)
        this.backgroundColor = new N.RGBA(255, 0, 0, 1, 1);
      if (this.fontColor == null)
        this.fontColor = new N.RGBA(255, 255, 255, 1, 1);
    }
  },
  FaviconIconSource: {
    "": "FaviconDrawable;linkElement,_image,_hasLoaded,_remove,_animationQueue,_currentQueue,_isTransitioning,x,y,scale,opacity,width,height,targetX,targetY,targetScale,targetOpacity,_parent",
    onDraw$1: function(ctx) {
      var t1, t2, t3, t4;
      if (this._hasLoaded) {
        t1 = this._image;
        t2 = this.x;
        t3 = this.y;
        t4 = this._parent.size;
        J.drawImageScaled$5$x(ctx, t1, t2, t3, t4, t4);
      }
    },
    FaviconIconSource$1: function(linkElement) {
      var e, t1;
      e = document.createElement("img", null);
      this._image = e;
      t1 = this.linkElement;
      if (t1 == null) {
        t1 = W._FrozenElementList$_wrap(document.querySelectorAll("head > link[rel$='icon']"), null)._nodeList;
        if (t1.length > 0) {
          t1 = t1[0];
          this.linkElement = t1;
          J.set$src$x(this._image, J.get$href$x(t1));
        } else {
          P.print("Could not find favicon tag to load the image from. Attempting to load default favicon from server");
          J.set$src$x(this._image, "/favicon.ico");
        }
      } else
        J.set$src$x(e, J.get$href$x(t1));
      t1 = J.get$onLoad$x(this._image);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.FaviconIconSource_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onError$x(this._image);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.FaviconIconSource_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {FaviconIconSource$: function(linkElement) {
        var t1 = new N.FaviconIconSource(linkElement, null, false, false, H.setRuntimeTypeInfo([], [N.FaviconFrame]), new N.FaviconFrame(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), H.setRuntimeTypeInfo([], [N.FavicoTween])), false, 0, 0, 1, 1, 0, 0, 0, 0, 1, 1, null);
        t1.FaviconIconSource$1(linkElement);
        return t1;
      }}
  },
  FaviconIconSource_closure: {
    "": "Closure:11;this_0",
    call$1: function(ev) {
      this.this_0._hasLoaded = true;
    }
  },
  FaviconIconSource_closure0: {
    "": "Closure:11;this_1",
    call$1: function(ev) {
      var t1 = this.this_1;
      P.print("Could not load image: " + H.S(J.get$src$x(t1._image)) + " ... Removing from favicon");
      t1._remove = true;
    }
  },
  FaviconVideoSource: {
    "": "FaviconDrawable;source,autoLoop,_remove,_animationQueue,_currentQueue,_isTransitioning,x,y,scale,opacity,width,height,targetX,targetY,targetScale,targetOpacity,_parent",
    onDraw$1: function(ctx) {
      var t1, t2, t3;
      t1 = this.x;
      t2 = this.y;
      t3 = this._parent.size;
      J.drawImageScaled$5$x(ctx, this.source, t1, t2, t3, t3);
    }
  }
},
1],
...
N.FaviconDrawable.$isFaviconDrawable = true;
N.FaviconDrawable.$isObject = true;
N.FaviconFrame.$isObject = true;
N.FavicoTween.$isFavicoTween = true;
N.FavicoTween.$isObject = true;
...
C.FaviconPosition_0 = new N.FaviconPosition(0);
C.FaviconPosition_1 = new N.FaviconPosition(1);
C.FaviconPosition_2 = new N.FaviconPosition(2);
C.FaviconPosition_3 = new N.FaviconPosition(3);
...
C.Symbol_fade = new H.Symbol0("fade");
C.Symbol_fadeIn = new H.Symbol0("fadeIn");
C.Symbol_fadeOut = new H.Symbol0("fadeOut");
C.Symbol_slide = new H.Symbol0("slide");
C.Symbol_slideInDown = new H.Symbol0("slideInDown");
C.Symbol_slideInLeft = new H.Symbol0("slideInLeft");
C.Symbol_slideInRight = new H.Symbol0("slideInRight");
C.Symbol_slideInUp = new H.Symbol0("slideInUp");
C.Symbol_slideOutDown = new H.Symbol0("slideOutDown");
C.Symbol_slideOutLeft = new H.Symbol0("slideOutLeft");
C.Symbol_slideOutRight = new H.Symbol0("slideOutRight");
C.Symbol_slideOutUp = new H.Symbol0("slideOutUp");
C.Symbol_wait = new H.Symbol0("wait");
...
$.FaviconDrawable__initialized = false;
...
Isolate.$lazy($, "_transitions", "FaviconDrawable__transitions", "get$FaviconDrawable__transitions", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, P.Symbol, {func: "bool__FaviconDrawable_double_List_FavicoTween", ret: J.JSBool, args: [N.FaviconDrawable, J.JSDouble, J.JSArray, N.FavicoTween]});
});
// Native classes
...
{func: "bool__FaviconDrawable_double_List_FavicoTween", ret: J.JSBool, args: [N.FaviconDrawable, J.JSDouble, J.JSArray, N.FavicoTween]},
{func: "dynamic__FaviconDrawable_double_List_FavicoTween", args: [N.FaviconDrawable, J.JSDouble, J.JSArray, N.FavicoTween]},
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "run$1,call$0,call$1,call$2,call$3,call$4,call$5,eval$1,get$_id,toRti$0,write$1,_close$0,cancel$0,get$_key,lookup$1,resume$0,get$_name,get$_next,get$_zone,process$0,set$_next,get$_error,get$_value,runUnary$2,writeAll$2,_complete$1,_setError$2,_setValue$1,allowsUri$1,get$varData,runBinary$3,set$varData,get$_onError,get$_onValue,get$isMethod,runGuarded$1,_addPending$1,_async$_add$1,containsKey$1,createTimer$2,get$_contents,get$_duration,get$_hasError,get$_isClosed,get$_previous,get$uriPolicy,set$_previous,get$_errorTest,get$_errorZone,get$memberName,get$stackTrace,set$_isChained,allowsElement$1,get$_isComplete,get$scaledWidth,_completeError$2,cancelSchedule$0,get$isFirstFrame,get$scaledHeight,allowsAttribute$3,get$_nextListener,inSameErrorZone$1,runUnaryGuarded$2,set$_nextListener,set$targetOpacity,_removeListeners$0,get$isolateStatics,get$namedArguments,registerCallback$1,handleUncaughtError$2,get$_collection$_value,set$_collection$_value,__isolate_helper$_add$1,get$_whenCompleteAction,get$positionalArguments,registerUnaryCallback$1,get$_collection$_element,registerBinaryCallback$1".split(","), longNames = "run,call,call,call,call,call,call,eval,_id,toRti,write,_close,cancel,_key,lookup,resume,_name,_next,_zone,process,_next=,_error,_value,runUnary,writeAll,_complete,_setError,_setValue,allowsUri,varData,runBinary,varData=,_onError,_onValue,isMethod,runGuarded,_addPending,_add,containsKey,createTimer,_contents,_duration,_hasError,_isClosed,_previous,uriPolicy,_previous=,_errorTest,_errorZone,memberName,stackTrace,_isChained=,allowsElement,_isComplete,scaledWidth,_completeError,cancelSchedule,isFirstFrame,scaledHeight,allowsAttribute,_nextListener,inSameErrorZone,runUnaryGuarded,_nextListener=,targetOpacity=,_removeListeners,isolateStatics,namedArguments,registerCallback,handleUncaughtError,_value,_value=,_add,_whenCompleteAction,positionalArguments,registerUnaryCallback,_element,registerBinaryCallback".split(",");
...
function dart_precompiled($collectedClasses) {
  ...
  AnchorElement.prototype.set$rel = function(receiver, v) {
    return receiver.rel = v;
  };
  ...
  LinkElement.prototype.set$rel = function(receiver, v) {
    return receiver.rel = v;
  };
  ...
  FEConvolveMatrixElement.prototype.get$targetX = function(receiver) {
    return receiver.targetX;
  };
  FEConvolveMatrixElement.prototype.get$targetY = function(receiver) {
  ...
  function main__closure(badge_0) {
    this.badge_0 = badge_0;
  }
  ...
  function Favicon(_canvas, _context, elements, destinationElement, updateFavicon, size, _stopwatch, _prevFrameTime) {
    ...
    this._prevFrameTime = _prevFrameTime;
  }
  Favicon.builtin$cls = "Favicon";
  if (!"name" in Favicon)
    Favicon.name = "Favicon";
  $desc = $collectedClasses.Favicon;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Favicon.prototype = $desc;
  Favicon.prototype.get$size = function(receiver) {
    return this.size;
  };
  function FaviconDrawable(x, y, opacity, targetX, targetY, targetOpacity) {
    this.x = x;
    this.y = y;
  ...
  FaviconDrawable.builtin$cls = "FaviconDrawable";
  if (!"name" in FaviconDrawable)
    FaviconDrawable.name = "FaviconDrawable";
  $desc = $collectedClasses.FaviconDrawable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable.prototype = $desc;
  FaviconDrawable.prototype.get$x = function(receiver) {
    return this.x;
  };
  FaviconDrawable.prototype.set$x = function(receiver, v) {
    return this.x = v;
  };
  FaviconDrawable.prototype.get$y = function(receiver) {
    return this.y;
  };
  FaviconDrawable.prototype.set$y = function(receiver, v) {
    return this.y = v;
  };
  FaviconDrawable.prototype.get$opacity = function(receiver) {
    return this.opacity;
  };
  FaviconDrawable.prototype.set$opacity = function(receiver, v) {
    return this.opacity = v;
  };
  FaviconDrawable.prototype.get$targetX = function(receiver) {
    return this.targetX;
  };
  FaviconDrawable.prototype.set$targetX = function(receiver, v) {
    return this.targetX = v;
  };
  FaviconDrawable.prototype.get$targetY = function(receiver) {
    return this.targetY;
  };
  FaviconDrawable.prototype.set$targetY = function(receiver, v) {
    return this.targetY = v;
  };
  FaviconDrawable.prototype.set$targetOpacity = function(v) {
    return this.targetOpacity = v;
  };
  function FaviconDrawable__init_slide() {
  }
  FaviconDrawable__init_slide.builtin$cls = "FaviconDrawable__init_slide";
  if (!"name" in FaviconDrawable__init_slide)
    FaviconDrawable__init_slide.name = "FaviconDrawable__init_slide";
  $desc = $collectedClasses.FaviconDrawable__init_slide;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_slide.prototype = $desc;
  function FaviconDrawable__init_closure(slide_0) {
    this.slide_0 = slide_0;
  }
  FaviconDrawable__init_closure.builtin$cls = "FaviconDrawable__init_closure";
  if (!"name" in FaviconDrawable__init_closure)
    FaviconDrawable__init_closure.name = "FaviconDrawable__init_closure";
  $desc = $collectedClasses.FaviconDrawable__init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure.prototype = $desc;
  function FaviconDrawable__init_closure0(slide_1) {
    this.slide_1 = slide_1;
  }
  FaviconDrawable__init_closure0.builtin$cls = "FaviconDrawable__init_closure0";
  if (!"name" in FaviconDrawable__init_closure0)
    FaviconDrawable__init_closure0.name = "FaviconDrawable__init_closure0";
  $desc = $collectedClasses.FaviconDrawable__init_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure0.prototype = $desc;
  function FaviconDrawable__init_closure1(slide_2) {
    this.slide_2 = slide_2;
  }
  FaviconDrawable__init_closure1.builtin$cls = "FaviconDrawable__init_closure1";
  if (!"name" in FaviconDrawable__init_closure1)
    FaviconDrawable__init_closure1.name = "FaviconDrawable__init_closure1";
  $desc = $collectedClasses.FaviconDrawable__init_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure1.prototype = $desc;
  function FaviconDrawable__init_closure2(slide_3) {
    this.slide_3 = slide_3;
  }
  FaviconDrawable__init_closure2.builtin$cls = "FaviconDrawable__init_closure2";
  if (!"name" in FaviconDrawable__init_closure2)
    FaviconDrawable__init_closure2.name = "FaviconDrawable__init_closure2";
  $desc = $collectedClasses.FaviconDrawable__init_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure2.prototype = $desc;
  function FaviconDrawable__init_closure3(slide_4) {
    this.slide_4 = slide_4;
  }
  FaviconDrawable__init_closure3.builtin$cls = "FaviconDrawable__init_closure3";
  if (!"name" in FaviconDrawable__init_closure3)
    FaviconDrawable__init_closure3.name = "FaviconDrawable__init_closure3";
  $desc = $collectedClasses.FaviconDrawable__init_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure3.prototype = $desc;
  function FaviconDrawable__init_closure4(slide_5) {
    this.slide_5 = slide_5;
  }
  FaviconDrawable__init_closure4.builtin$cls = "FaviconDrawable__init_closure4";
  if (!"name" in FaviconDrawable__init_closure4)
    FaviconDrawable__init_closure4.name = "FaviconDrawable__init_closure4";
  $desc = $collectedClasses.FaviconDrawable__init_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure4.prototype = $desc;
  function FaviconDrawable__init_closure5(slide_6) {
    this.slide_6 = slide_6;
  }
  FaviconDrawable__init_closure5.builtin$cls = "FaviconDrawable__init_closure5";
  if (!"name" in FaviconDrawable__init_closure5)
    FaviconDrawable__init_closure5.name = "FaviconDrawable__init_closure5";
  $desc = $collectedClasses.FaviconDrawable__init_closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure5.prototype = $desc;
  function FaviconDrawable__init_closure6(slide_7) {
    this.slide_7 = slide_7;
  }
  FaviconDrawable__init_closure6.builtin$cls = "FaviconDrawable__init_closure6";
  if (!"name" in FaviconDrawable__init_closure6)
    FaviconDrawable__init_closure6.name = "FaviconDrawable__init_closure6";
  $desc = $collectedClasses.FaviconDrawable__init_closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure6.prototype = $desc;
  function FaviconDrawable__init_fade() {
  }
  FaviconDrawable__init_fade.builtin$cls = "FaviconDrawable__init_fade";
  if (!"name" in FaviconDrawable__init_fade)
    FaviconDrawable__init_fade.name = "FaviconDrawable__init_fade";
  $desc = $collectedClasses.FaviconDrawable__init_fade;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_fade.prototype = $desc;
  function FaviconDrawable__init_closure7(fade_8) {
    this.fade_8 = fade_8;
  }
  FaviconDrawable__init_closure7.builtin$cls = "FaviconDrawable__init_closure7";
  if (!"name" in FaviconDrawable__init_closure7)
    FaviconDrawable__init_closure7.name = "FaviconDrawable__init_closure7";
  $desc = $collectedClasses.FaviconDrawable__init_closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure7.prototype = $desc;
  function FaviconDrawable__init_closure8(fade_9) {
    this.fade_9 = fade_9;
  }
  FaviconDrawable__init_closure8.builtin$cls = "FaviconDrawable__init_closure8";
  if (!"name" in FaviconDrawable__init_closure8)
    FaviconDrawable__init_closure8.name = "FaviconDrawable__init_closure8";
  $desc = $collectedClasses.FaviconDrawable__init_closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure8.prototype = $desc;
  function FaviconDrawable__init_closure9() {
  }
  FaviconDrawable__init_closure9.builtin$cls = "FaviconDrawable__init_closure9";
  if (!"name" in FaviconDrawable__init_closure9)
    FaviconDrawable__init_closure9.name = "FaviconDrawable__init_closure9";
  $desc = $collectedClasses.FaviconDrawable__init_closure9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconDrawable__init_closure9.prototype = $desc;
  function FaviconFrame(c, transitions) {
    this.c = c;
    this.transitions = transitions;
  }
  FaviconFrame.builtin$cls = "FaviconFrame";
  if (!"name" in FaviconFrame)
    FaviconFrame.name = "FaviconFrame";
  $desc = $collectedClasses.FaviconFrame;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconFrame.prototype = $desc;
  function FavicoTween(animationName, c, duration, frameNumber, state, parameters) {
  ...
  FavicoTween.builtin$cls = "FavicoTween";
  if (!"name" in FavicoTween)
    FavicoTween.name = "FavicoTween";
  $desc = $collectedClasses.FavicoTween;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FavicoTween.prototype = $desc;
  FavicoTween.prototype.get$duration = function(receiver) {
    return this.duration;
  };
  FavicoTween.prototype.get$state = function(receiver) {
    return this.state;
  };
  function FaviconPosition(pos) {
    this.pos = pos;
  }
  FaviconPosition.builtin$cls = "FaviconPosition";
  if (!"name" in FaviconPosition)
    FaviconPosition.name = "FaviconPosition";
  $desc = $collectedClasses.FaviconPosition;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconPosition.prototype = $desc;
  function RGBA(r, g, b, a, alphaMod) {
    this.r = r;
    this.g = g;
    this.b = b;
    this.a = a;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  RGBA.prototype = $desc;
  function FaviconBadge(backgroundColor, fontColor, font, type, position, badgeUpdateQueue, currBadge, padding, _lastBadgeNum, _remove, _animationQueue, _currentQueue, _isTransitioning, x, y, scale, opacity, width, height, targetX, targetY, targetScale, targetOpacity, _parent) {
    this.backgroundColor = backgroundColor;
    this.fontColor = fontColor;
    this.font = font;
    this.type = type;
    this.position = position;
    this.badgeUpdateQueue = badgeUpdateQueue;
    this.currBadge = currBadge;
    this.padding = padding;
    this._lastBadgeNum = _lastBadgeNum;
    this._remove = _remove;
    this._animationQueue = _animationQueue;
    this._currentQueue = _currentQueue;
    this._isTransitioning = _isTransitioning;
    this.x = x;
    this.y = y;
    this.scale = scale;
    this.opacity = opacity;
  ...
  FaviconBadge.builtin$cls = "FaviconBadge";
  if (!"name" in FaviconBadge)
    FaviconBadge.name = "FaviconBadge";
  $desc = $collectedClasses.FaviconBadge;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconBadge.prototype = $desc;
  function FaviconIconSource(linkElement, _image, _hasLoaded, _remove, _animationQueue, _currentQueue, _isTransitioning, x, y, scale, opacity, width, height, targetX, targetY, targetScale, targetOpacity, _parent) {
  ...
  FaviconIconSource.builtin$cls = "FaviconIconSource";
  if (!"name" in FaviconIconSource)
    FaviconIconSource.name = "FaviconIconSource";
  $desc = $collectedClasses.FaviconIconSource;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconIconSource.prototype = $desc;
  function FaviconIconSource_closure(this_0) {
    this.this_0 = this_0;
  }
  FaviconIconSource_closure.builtin$cls = "FaviconIconSource_closure";
  if (!"name" in FaviconIconSource_closure)
    FaviconIconSource_closure.name = "FaviconIconSource_closure";
  $desc = $collectedClasses.FaviconIconSource_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconIconSource_closure.prototype = $desc;
  function FaviconIconSource_closure0(this_1) {
    this.this_1 = this_1;
  }
  FaviconIconSource_closure0.builtin$cls = "FaviconIconSource_closure0";
  if (!"name" in FaviconIconSource_closure0)
    FaviconIconSource_closure0.name = "FaviconIconSource_closure0";
  $desc = $collectedClasses.FaviconIconSource_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconIconSource_closure0.prototype = $desc;
  function FaviconVideoSource(source, autoLoop, _remove, _animationQueue, _currentQueue, _isTransitioning, x, y, scale, opacity, width, height, targetX, targetY, targetScale, targetOpacity, _parent) {
    this.source = source;
  ...
  FaviconVideoSource.builtin$cls = "FaviconVideoSource";
  if (!"name" in FaviconVideoSource)
    FaviconVideoSource.name = "FaviconVideoSource";
  $desc = $collectedClasses.FaviconVideoSource;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconVideoSource.prototype = $desc;
