...
["", "favico.dart", , N, {
  "": "",
  main: [function() {
    new N.Favicon(null, null, H.setRuntimeTypeInfo([], [N.FaviconDrawable]), null, 16, 0).Favicon$2$destinationElement$size(null, 16);
  }, "call$0", "main$closure", 0, 0, 0],
  Favicon: {
    "": "Object;_canvas,_context,elements,destinationElement,size,_prevVal",
    _beginLoop$1: [function(t) {
      var timeElapsed, t1, t2;
      timeElapsed = J.$sub$n(t, this._prevVal);
      this._prevVal = t;
      P.print(timeElapsed);
      t1 = window;
      t2 = this.get$_beginLoop();
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
    }, "call$1", "get$_beginLoop", 2, 0, 17],
    Favicon$2$destinationElement$size: function(destinationElement, size) {
      var e, t1, t2;
      e = document.createElement("canvas", null);
      this._canvas = e;
      J.set$width$x(e, this.size);
...
function dart_precompiled($collectedClasses) {
  ...
  function Favicon(_canvas, _context, elements, destinationElement, size, _prevVal) {
    this._canvas = _canvas;
    this._context = _context;
    this.elements = elements;
    this.destinationElement = destinationElement;
    this.size = size;
    this._prevVal = _prevVal;
  }
