...
([
["FaviconDart", "package:favicon_dart/favicon_dart.dart", , V, {
  "": "",
  BrowserDetect_detect: function(UA) {
    UA.toString;
    UA = UA.toLowerCase();
    if (C.JSString_methods.indexOf$1(UA, "opera") !== -1)
      return $.BrowserDetect_OPERA;
    if (C.JSString_methods.indexOf$1(UA, "firefox") !== -1)
      return $.BrowserDetect_FIREFOX;
    if (C.JSString_methods.indexOf$1(UA, "chrome") !== -1)
      return $.BrowserDetect_CHROME;
    if (C.JSString_methods.indexOf$1(UA, "safari") !== -1)
      return $.BrowserDetect_SAFARI;
    if (C.JSString_methods.indexOf$1(UA, "msie") !== -1 || C.JSString_methods.indexOf$1(UA, "trident") !== -1)
      return $.BrowserDetect_INTERNET_EXPLORER;
    if (C.JSString_methods.indexOf$1(UA, "webkit") !== -1)
      return $.BrowserDetect_UNKNOWN_WEBKIT;
    return $.BrowserDetect_UNKNOWN;
  },
  Favicon: {
    "": "Object;elements,destinationElement,size,applyOptimisations,_canvas,_context,_browser,_prevFrameTime,_stopwatch",
    _loopDraw$0: [function() {
      var t1, t2, t, timeElapsed, eleLength, x, currentDrawable;
      P.Timer_Timer(P.Duration$(0, 0, 0, 33, 0, 0), this.get$_loopDraw());
      t1 = this._canvas;
      ...
      this._updateImage$1(J.toDataUrl$0$x(this._canvas));
    }, "call$0", "get$_loopDraw", 0, 0, 0],
    _updateImage$1: function(base64Image) {
      var t1, t2;
      t1 = this.destinationElement;
      t2 = J.getInterceptor(t1);
      if (typeof t1 === "object" && t1 !== null && !!t2.$isLinkElement) {
        t2.setAttribute$2(t1, "href", base64Image);
        if (this._browser === $.BrowserDetect_FIREFOX && this.applyOptimisations) {
          J.remove$0$ax(this.destinationElement);
          document.head.appendChild(this.destinationElement);
        }
        return;
      }
      t2.setAttribute$2(t1, "src", base64Image);
    },
    ...
    Favicon$2$destinationElement$size: function(destinationElement, size) {
      ...
      if (this.destinationElement == null) {
        t1 = W._FrozenElementList$_wrap(document.querySelectorAll("link[rel$='icon']"), null)._nodeList;
        if (t1.length > 0)
          this.destinationElement = t1[0];
        else {
          t1 = document.createElement("link", null);
          t2 = J.getInterceptor$x(t1);
          t2.set$rel(t1, "icon");
          t2.set$type(t1, "image/png");
          this.destinationElement = t1;
        }
      }
      this._browser = V.BrowserDetect_detect(window.navigator.userAgent);
  ...
  Position: {
    "": "Object;pos",
    static: {"": "Position_TOP_LEFT,Position_TOP_RIGHT,Position_BOTTOM_LEFT,Position_BOTTOM_RIGHT"}
  },
  Badge: {
    "": "FaviconElement;backgroundColor,fontColor,font,type>,position,badgeUpdateQueue,currBadge,padding,showAbove,fontSize,_remove,_transitionQueue,_currentQueue,_isTransitioning,state,_parent",
    ...
    onDraw$1: function(ctx) {
      var t1, badgeText, fontWidth, fontHeight, t2, t3, t4, t5, t6, t7, r;
      t1 = this.currBadge;
      badgeText = this.convertBadgeToText$1(t1);
      J.set$font$x(ctx, this.font);
      fontWidth = ctx.measureText(badgeText).width;
      fontHeight = this.fontSize * 0.9;
      if (typeof fontWidth !== "number")
        return fontWidth.$add();
      t2 = this.state;
      t3 = t2.state;
      t3.$indexSet(0, "container_width", fontWidth + 4);
      t3.$indexSet(t3, "container_height", fontHeight + 4);
      this.backgroundColor.alphaMod = t2.get$1("opacity");
      ctx.fillStyle = J.toString$0(this.backgroundColor);
      switch (this.position) {
        ...
        case C.Position_1:
          ...
          t4 = t2.get$1("container_width");
          if (typeof t4 !== "number")
            return H.iae(t4);
          ctx.translate(t3 - t4 - this.padding, 2);
          break;
        case C.Position_2:
          t3 = this._parent.size;
          t4 = t2.get$1("container_height");
          if (typeof t4 !== "number")
            return H.iae(t4);
          ctx.translate(2, t3 - t4 - this.padding);
          break;
        case C.Position_3:
          t3 = this._parent.size;
          t4 = t2.get$1("container_width");
          if (typeof t4 !== "number")
            return H.iae(t4);
          t5 = this.padding;
          t6 = this._parent.size;
          t7 = t2.get$1("container_height");
          if (typeof t7 !== "number")
            return H.iae(t7);
          ctx.translate(t3 - t4 - t5, t6 - t7 - t5);
          break;
        default:
      }
      if (this.type === "rounded") {
        if (J.$lt$n(t2.get$1("container_width"), 10)) {
          t3 = t2.get$1("container_width");
          if (typeof t3 !== "number")
            return t3.$div();
          r = t3 / 2;
        } else
          r = 5;
        if (J.$lt$n(t2.get$1("container_height"), 2 * r)) {
          t3 = t2.get$1("container_height");
          if (typeof t3 !== "number")
            return t3.$div();
          r = t3 / 2;
        }
        ctx.beginPath();
        ctx.moveTo(J.$add$ns(t2.get$1("x"), r), t2.get$1("y"));
        ctx.arcTo(J.$add$ns(t2.get$1("x"), t2.get$1("container_width")), t2.get$1("y"), J.$add$ns(t2.get$1("x"), t2.get$1("container_width")), J.$add$ns(t2.get$1("y"), t2.get$1("container_height")), r);
        ctx.arcTo(J.$add$ns(t2.get$1("x"), t2.get$1("container_width")), J.$add$ns(t2.get$1("y"), t2.get$1("container_height")), t2.get$1("x"), J.$add$ns(t2.get$1("y"), t2.get$1("container_height")), r);
        ctx.arcTo(t2.get$1("x"), J.$add$ns(t2.get$1("y"), t2.get$1("container_height")), t2.get$1("x"), t2.get$1("y"), r);
        ctx.arcTo(t2.get$1("x"), t2.get$1("y"), J.$add$ns(t2.get$1("x"), t2.get$1("container_width")), t2.get$1("y"), r);
        ctx.closePath();
        ctx.fill();
      } else
        ctx.fillRect(t2.get$1("x"), t2.get$1("y"), t2.get$1("container_width"), t2.get$1("container_height"));
      this.fontColor.alphaMod = t2.get$1("opacity");
      ctx.fillStyle = J.toString$0(this.fontColor);
      t1 = this.convertBadgeToText$1(t1);
      t3 = J.$add$ns(t2.get$1("x"), 2);
      t2 = t2.get$1("y");
      if (typeof t2 !== "number")
        return H.iae(t2);
      ctx.fillText(t1, t3, fontHeight + 2 + t2);
    },
    onUpdate$1: function(deltaT) {
    },
    Badge$8$backgroundColor$font$fontColor$fontSize$padding$position$showAbove$type: function(backgroundColor, font, fontColor, fontSize, padding, position, showAbove, type) {
      var t1 = this.state;
      if (this.currBadge > this.showAbove)
        t1.state.$indexSet(0, "opacity", 1);
      else
        t1.state.$indexSet(0, "opacity", 0);
      if (this.backgroundColor == null)
        this.backgroundColor = new V.RGBA(255, 0, 0, 1, 1);
      if (this.fontColor == null)
        this.fontColor = new V.RGBA(255, 255, 255, 1, 1);
    }
  },
  TransitionStateContainer: {
    "": "Object;state,durations",
    get$1: function(key) {
      var t1 = this.state;
  ...
  TransitionEventType: {
    "": "Object;type>",
    static: {"": "TransitionEventType_STEP,TransitionEventType_STOP,TransitionEventType_BEGIN"}
  },
  TransitionEvent: {
    "": "Object;type>,item"
  },
  FaviconElement: {
    "": "Object;",
    transition$3$addToQueue$duration: function(transitionItems, addToQueue, duration) {
      var t1, insertedTransition;
      if (addToQueue) {
        t1 = this._currentQueue;
        t1.toState.state.addAll$1(0, transitionItems);
        transitionItems.forEach$1(0, new V.FaviconElement_transition_closure(this, duration));
        return t1;
      } else {
        t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt);
        insertedTransition = new V.TransitionItem(false, P.StreamController_StreamController(null, null, null, null, false, V.TransitionEvent), new V.TransitionStateContainer(transitionItems, t1), null, 0);
        transitionItems.forEach$1(0, new V.FaviconElement_transition_closure0(duration, insertedTransition));
        this._transitionQueue.push(insertedTransition);
        return insertedTransition;
      }
    },
    transition$2$duration: function(transitionItems, duration) {
      return this.transition$3$addToQueue$duration(transitionItems, false, duration);
    },
    _onUpdate$1: function(timeSinceLastFrame) {
      var t1, curr, t2, clonedCopy, toState, fromState, tsL, elementKeys, x, tk, val, fromS, t3, step, isComplete;
      if (this._isTransitioning) {
        t1 = this._transitionQueue;
        if (t1.length >= 1) {
          curr = t1[0];
          t2 = curr.frameNumber;
          if (t2 === 0) {
            curr._sendEvent$1(new V.TransitionEvent(C.TransitionEventType_0, curr));
            curr.frameNumber = curr.frameNumber + 1;
            return;
          } else if (t2 === 1) {
            clonedCopy = P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, null);
            clonedCopy.addAll$1(0, this.state.state);
            curr.fromState = new V.TransitionStateContainer(clonedCopy, P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt));
          }
          t2 = curr.toState;
          toState = t2.state;
          fromState = curr.fromState.state;
          tsL = toState.get$length(toState);
          elementKeys = toState.get$keys();
          if (tsL > 0) {
            for (t1 = t2.durations, t2 = this.state.state, x = 0; x < tsL; ++x) {
              tk = elementKeys.elementAt$1(0, x);
              val = toState.$index(toState, tk);
              fromS = fromState.$index(0, tk);
              if (typeof val === "number" && fromState.containsKey$1(tk) && typeof fromS === "number") {
                t3 = J.getInterceptor$n(val);
                step = J.$div$n(t3.$sub(val, fromS), t1.$index(0, tk)) * timeSinceLastFrame;
                if (!(t3.$gt(val, fromS) && J.$ge$n(J.$add$ns(t2.$index(0, tk), step), val)))
                  t3 = t3.$lt(val, fromS) && J.$le$n(J.$add$ns(t2.$index(0, tk), step), val);
                else
                  t3 = true;
                if (t3) {
                  step = toState.$index(toState, tk);
                  isComplete = true;
                } else
                  isComplete = false;
                if (t2.containsKey$1(tk)) {
                  t3 = t2.$index(0, tk);
                  if (typeof t3 === "number")
                    t2.$indexSet(t2, tk, J.$add$ns(t2.$index(t2, tk), step));
                } else
                  t2.$indexSet(t2, tk, step);
              } else
                isComplete = false;
              if (isComplete) {
                --tsL;
                --x;
                toState.remove$1(toState, tk);
              }
            }
            curr._sendEvent$1(new V.TransitionEvent(C.TransitionEventType_2, curr));
            curr.frameNumber = curr.frameNumber + 1;
          } else {
            C.JSArray_methods.removeAt$1(t1, 0);
            curr._sendEvent$1(new V.TransitionEvent(C.TransitionEventType_1, curr));
          }
        }
      }
  ...
  FaviconElement_transition_closure: {
    "": "Closure:9;this_0,duration_1",
    call$2: function(item, nu) {
      this.this_0._currentQueue.toState.durations.$indexSet(0, item, this.duration_1);
    }
  },
  FaviconElement_transition_closure0: {
    "": "Closure:9;duration_2,insertedTransition_3",
    call$2: function(item, nu) {
      this.insertedTransition_3.toState.durations.$indexSet(0, item, this.duration_2);
    }
  },
  IconSource: {
    "": "FaviconElement;linkElement,_image,_hasLoaded,_remove,_transitionQueue,_currentQueue,_isTransitioning,state,_parent",
    onDraw$1: function(ctx) {
      var t1, t2, t3, t4;
      if (this._hasLoaded) {
        t1 = this._image;
        ...
        J.drawImageScaled$5$x(ctx, t1, t3, t2, t4, t4);
      }
    },
    IconSource$1: function(linkElement) {
      var e, t1;
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new V.IconSource_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onError$x(this._image);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new V.IconSource_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {IconSource$: function(linkElement) {
        var t1, t2, t3;
        t1 = H.setRuntimeTypeInfo([], [V.TransitionItem]);
        t2 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t3 = P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt);
        t3 = new V.IconSource(linkElement, null, false, false, t1, new V.TransitionItem(false, P.StreamController_StreamController(null, null, null, null, false, V.TransitionEvent), new V.TransitionStateContainer(t2, t3), null, 0), true, new V.TransitionStateContainer(H.fillLiteralMap(["x", 0, "y", 0, "opacity", 0, "scale", 0, "container_width", 0, "container_height", 0, "wait", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt)), null);
        t3.IconSource$1(linkElement);
        return t3;
      }}
  },
  IconSource_closure: {
  ...
  TransitionItem: {
    "": "Object;forceStopped,_eventStreamController,toState,fromState,frameNumber",
    _sendEvent$1: function(te) {
      var t1, t2;
      t1 = this._eventStreamController;
      t2 = t1._state;
      if ((t2 & 4) === 0) {
        if (t2 >= 4)
          H.throwExpression(t1._badEventState$0());
        t1._async$_add$1(te);
        if (te.type === C.TransitionEventType_1)
          t1.close$0(0);
      }
    }
  },
  RGBA: {
    "": "Object;_r,_g,_b,a,alphaMod",
    toString$0: function(_) {
      var t1, t2;
      t1 = "rgba(" + this._r + ", " + this._g + ", " + this._b + ", ";
      t2 = this.alphaMod;
      if (typeof t2 !== "number")
        return H.iae(t2);
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|TextMetrics"
  },
  JSBool: {
    "": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "": "Closure:16;box_1,box_2,listener_3,zone_4",
    call$0: function() {
...
["", "main.dart", , F, {
  "": "",
  main: [function() {
    var t1 = C.EventStreamProvider_load.forTarget$1(window);
  ...
  updateBadge: function(badge, n) {
    P.print("Start transition");
    badge.state.state.$indexSet(0, "opacity", 1);
    H.setRuntimeTypeInfo(new P._ControllerStream(badge.transition$2$duration(H.fillLiteralMap(["x", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), 500)._eventStreamController), [null]).listen$4$cancelOnError$onDone$onError(new F.updateBadge_closure(badge, n), null, null, null);
  },
  main_closure: {
    "": "Closure:10;",
    call$1: function(ev) {
      var t1, img, t2, icon, t3, t4, t5, badge, b;
      t1 = {};
      img = document.createElement("link", null);
      t2 = J.getInterceptor$x(img);
      t2.set$rel(img, "icon");
      t2.set$type(img, "image/png");
      icon = new V.Favicon(H.setRuntimeTypeInfo([], [V.FaviconElement]), img, 16, true, null, null, $.BrowserDetect_UNKNOWN, 0, new P.Stopwatch(null, null));
      icon.Favicon$2$destinationElement$size(img, 16);
      t2 = H.setRuntimeTypeInfo([], [J.JSInt]);
      t3 = H.setRuntimeTypeInfo([], [V.TransitionItem]);
      t4 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t5 = P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt);
      badge = new V.Badge(null, null, "bold sans-serif", "rounded", C.Position_3, t2, 0, 0, 0, 10, false, t3, new V.TransitionItem(false, P.StreamController_StreamController(null, null, null, null, false, V.TransitionEvent), new V.TransitionStateContainer(t4, t5), null, 0), true, new V.TransitionStateContainer(H.fillLiteralMap(["x", 0, "y", 0, "opacity", 0, "scale", 0, "container_width", 0, "container_height", 0, "wait", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSString, J.JSInt)), null);
      badge.Badge$8$backgroundColor$font$fontColor$fontSize$padding$position$showAbove$type(null, "bold sans-serif", null, 10, 0, C.Position_3, 0, "rounded");
      icon.addElement$1(V.IconSource$(null));
      icon.addElement$1(badge);
      document.head.appendChild(img);
      b = document.createElement("button", null);
      t5 = J.getInterceptor$x(b);
      t5.set$innerHtml(b, "+ 1");
      t1.badgeNum_0 = 1;
      t5 = t5.get$onClick(b);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t5._target, t5._eventType, W._wrapZone(new F.main__closure(t1, badge)), t5._useCapture), [H.getTypeArgumentByIndex(t5, 0)])._tryResume$0();
      document.body.appendChild(b);
    }
  },
  main__closure: {
    "": "Closure:10;box_0,badge_1",
    call$1: function(ev) {
      var t1 = this.box_0;
      t1.badgeNum_0 = t1.badgeNum_0 + 1;
      P.print("Pressed");
      F.updateBadge(this.badge_1, t1.badgeNum_0);
    }
  },
  updateBadge_closure: {
    "": "Closure:10;badge_0,n_1",
    call$1: function(t) {
      var t1;
      if (J.get$type$x(t) === C.TransitionEventType_0) {
        t1 = this.badge_0;
        t1.state.state.$indexSet(0, "x", t1._parent.size);
        t1.badgeUpdateQueue.push(this.n_1);
      }
    }
  }
},
...
V.FaviconElement.$isObject = true;
V.TransitionItem.$isObject = true;
V.TransitionEvent.$isObject = true;
...
C.Position_0 = new V.Position(0);
C.Position_1 = new V.Position(1);
C.Position_2 = new V.Position(2);
C.Position_3 = new V.Position(3);
C.TransitionEventType_0 = new V.TransitionEventType(0);
C.TransitionEventType_1 = new V.TransitionEventType(1);
C.TransitionEventType_2 = new V.TransitionEventType(2);
...
$.libraries_to_load = {};
$.BrowserDetect_FIREFOX = 1;
$.BrowserDetect_OPERA = 2;
$.BrowserDetect_CHROME = 3;
$.BrowserDetect_INTERNET_EXPLORER = 4;
$.BrowserDetect_SAFARI = 5;
$.BrowserDetect_UNKNOWN_WEBKIT = 6;
$.BrowserDetect_UNKNOWN = 6;
$.controlPort = null;
...
function dart_precompiled($collectedClasses) {
  ...
  function TransitionEvent0() {
  }
  TransitionEvent0.builtin$cls = "TransitionEvent0";
  if (!"name" in TransitionEvent0)
    TransitionEvent0.name = "TransitionEvent0";
  $desc = $collectedClasses.TransitionEvent0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransitionEvent0.prototype = $desc;
  function UIEvent() {
  }
  ...
  function Favicon(elements, destinationElement, size, applyOptimisations, _canvas, _context, _browser, _prevFrameTime, _stopwatch) {
    this.elements = elements;
    this.destinationElement = destinationElement;
    this.size = size;
    this.applyOptimisations = applyOptimisations;
  ...
  function Badge(backgroundColor, fontColor, font, type, position, badgeUpdateQueue, currBadge, padding, showAbove, fontSize, _remove, _transitionQueue, _currentQueue, _isTransitioning, state, _parent) {
    ...
    this._transitionQueue = _transitionQueue;
    this._currentQueue = _currentQueue;
    this._isTransitioning = _isTransitioning;
    this.state = state;
    this._parent = _parent;
  }
  Badge.builtin$cls = "Badge";
  if (!"name" in Badge)
    Badge.name = "Badge";
  $desc = $collectedClasses.Badge;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Badge.prototype = $desc;
  Badge.prototype.get$type = function(receiver) {
    return this.type;
  };
  function TransitionStateContainer(state, durations) {
    this.state = state;
    this.durations = durations;
  }
  TransitionStateContainer.builtin$cls = "TransitionStateContainer";
  if (!"name" in TransitionStateContainer)
    TransitionStateContainer.name = "TransitionStateContainer";
  $desc = $collectedClasses.TransitionStateContainer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransitionStateContainer.prototype = $desc;
  function TransitionEventType(type) {
    this.type = type;
  }
  TransitionEventType.builtin$cls = "TransitionEventType";
  if (!"name" in TransitionEventType)
    TransitionEventType.name = "TransitionEventType";
  $desc = $collectedClasses.TransitionEventType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransitionEventType.prototype = $desc;
  TransitionEventType.prototype.get$type = function(receiver) {
    return this.type;
  };
  function TransitionEvent(type, item) {
    this.type = type;
    this.item = item;
  }
  ...
  TransitionEvent.prototype.get$type = function(receiver) {
    return this.type;
  };
  function FaviconElement() {
  }
  FaviconElement.builtin$cls = "FaviconElement";
  if (!"name" in FaviconElement)
    FaviconElement.name = "FaviconElement";
  $desc = $collectedClasses.FaviconElement;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconElement.prototype = $desc;
  function FaviconElement_transition_closure(this_0, duration_1) {
    this.this_0 = this_0;
    this.duration_1 = duration_1;
  }
  FaviconElement_transition_closure.builtin$cls = "FaviconElement_transition_closure";
  if (!"name" in FaviconElement_transition_closure)
    FaviconElement_transition_closure.name = "FaviconElement_transition_closure";
  $desc = $collectedClasses.FaviconElement_transition_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconElement_transition_closure.prototype = $desc;
  function FaviconElement_transition_closure0(duration_2, insertedTransition_3) {
    this.duration_2 = duration_2;
    this.insertedTransition_3 = insertedTransition_3;
  }
  FaviconElement_transition_closure0.builtin$cls = "FaviconElement_transition_closure0";
  if (!"name" in FaviconElement_transition_closure0)
    FaviconElement_transition_closure0.name = "FaviconElement_transition_closure0";
  $desc = $collectedClasses.FaviconElement_transition_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FaviconElement_transition_closure0.prototype = $desc;
  function IconSource(linkElement, _image, _hasLoaded, _remove, _transitionQueue, _currentQueue, _isTransitioning, state, _parent) {
  ...
  IconSource.builtin$cls = "IconSource";
  if (!"name" in IconSource)
    IconSource.name = "IconSource";
  $desc = $collectedClasses.IconSource;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IconSource.prototype = $desc;
  function IconSource_closure(this_0) {
    this.this_0 = this_0;
  }
  IconSource_closure.builtin$cls = "IconSource_closure";
  if (!"name" in IconSource_closure)
    IconSource_closure.name = "IconSource_closure";
  $desc = $collectedClasses.IconSource_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IconSource_closure.prototype = $desc;
  function IconSource_closure0(this_1) {
    this.this_1 = this_1;
  }
  IconSource_closure0.builtin$cls = "IconSource_closure0";
  if (!"name" in IconSource_closure0)
    IconSource_closure0.name = "IconSource_closure0";
  $desc = $collectedClasses.IconSource_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IconSource_closure0.prototype = $desc;
  function TransitionItem(forceStopped, _eventStreamController, toState, fromState, frameNumber) {
    this.forceStopped = forceStopped;
    this._eventStreamController = _eventStreamController;
    this.toState = toState;
    this.fromState = fromState;
    this.frameNumber = frameNumber;
  }
  TransitionItem.builtin$cls = "TransitionItem";
  if (!"name" in TransitionItem)
    TransitionItem.name = "TransitionItem";
  $desc = $collectedClasses.TransitionItem;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransitionItem.prototype = $desc;
  function RGBA(_r, _g, _b, a, alphaMod) {
    this._r = _r;
    this._g = _g;
    this._b = _b;
    this.a = a;
  ...
  function main__closure(box_0, badge_1) {
    this.box_0 = box_0;
    this.badge_1 = badge_1;
  }
